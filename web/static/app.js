...
const __OS_I18N = {
  zh: {
    ...
    "sidebar.ai_transition_warning_body": "AI 转场会额外触发视频生成调用，处理时间通常显著高于常规文案或配音流程，建议按需使用。",
  ...
  en: {
    ...
    "sidebar.ai_transition_warning_body": "AI transitions trigger additional video-generation calls and usually take significantly longer than regular copywriting or voiceover workflows. We recommend using them as needed.",
